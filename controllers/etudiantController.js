...
exports.createEtudiant = async (req, res) => {
    try {
        ...
        const exits = await Etudiant.findOne({nom: req.body.nom, prenom: req.body.prenom});
        if (exits) {
            return res.status(400).json({
                success: false,
...
// Cette fonction supprime un étudiant. 
...
exports.deleteEtudiant = async (req, res) => {
    try {
        ...
        res.status(200).json({
            ...
            data: {}  // On retourne l'étudiant modifié (actif: false)
        });
...
// ============================================
// SEARCH - Rechercher des étudiants par nom et prenom
// ============================================
